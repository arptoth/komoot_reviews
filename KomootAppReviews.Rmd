---
title: "Why people like Komoot in the USA"
author: "Text Analysis based on 157 user reviews in US App Store"
output: 
  html_document: 
    highlight: zenburn
    theme: yeti
...
## Introduction
 ...
 The job description is here: <http://https://www.komoot.com/jobs/data-analyst>). This is report is the "Doing something creative with komoot" part.
...
## What I did
 ...
 5. Make recommendations on how to improve user satisfaction in the US
...
Based on text analysis I found the following information:
 ...
 3. The most unrated versions are the 8.0 and 8.0.1, also 9.7.1 is less rated then the others in 9.x branch
 4. Mosty people love komoot because of the ability of planning and tracking features


## Actionable insights

My overall recommendations based on this supersmall dataset:

 1. Increase the penetration in other contries (like France, UK, Canada and the USA)
...
## Let' explore the data
 ...
 The iTunes shows 4.2 average rating in the USA. Let's check that by calculate mean of all score points. It seems the same.
